...
find /mnt/jupyter/jupyter-jh-v4-test/course/ -maxdepth 3 -name gradebook.db -mtime -14 \
  -exec python3 /root/jupyterhub-aalto/scripts/nbgrader-gradebook-update-student-names.py /mnt/jupyter/jupyter-jh-v4-test/admin/lastlogin/ {} \;
